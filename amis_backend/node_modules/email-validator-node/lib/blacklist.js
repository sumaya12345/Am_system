...
const BLACKLIST_COUNT = blacklistedDomains.length;
function getBlacklistStats() {
    return {
        totalDomains: BLACKLIST_COUNT,
        memoryUsage: Math.round((JSON.stringify(blacklistedDomains).length * 2) / 1024)
    };
}

exports.BLACKLISTED_DOMAINS = BLACKLISTED_DOMAINS;
exports.BLACKLIST_COUNT = BLACKLIST_COUNT;
exports.blacklistedDomains = blacklistedDomains;
