...
// Generated blacklist domains from blacklist.js
const blacklistedDomains = Object.freeze([
    '0-00.usa.cc',
    '0-attorney.com',
    '0-mail.com',
    '00.msk.ru',
...
const BLACKLISTED_DOMAINS = Object.freeze(new Set(blacklistedDomains));
...
function domainSuffixes(email) {
    ...
    return Array.from({ length: domainComponents.length }, (_, n) => domainComponents.slice(n).join("."));
}
/**
 * Usage
...
function isBlacklisted(email) {
    return domainSuffixes(email).some(domainSuffix => BLACKLISTED_DOMAINS.has(domainSuffix));
}
/**
 * Usage
 ...
 * @return {validateEmailResponse} true is the specified email is valid, false otherwise
 */
async function isMXRecordValid(email, timeout = 3000) {
    ...
    return new Promise((resolve) => {
        ...
        try {
            dns__namespace.resolveMx(domain, (err, mx) => {
                if (isResolved)
                    return;
                isResolved = true;
                ...
                if (mx && typeof mx !== "undefined") {
                    ...
                    const hasNullMx = mx.length > 0 &&
                        mx.some((record) => !record.exchange || record.exchange === '.' || record.exchange === '');
                    if (hasNullMx) {
                ...
                else if ((err === null || err === void 0 ? void 0 : err.code) === "ENOTFOUND" || (err === null || err === void 0 ? void 0 : err.code) === "ENODATA" || (err === null || err === void 0 ? void 0 : err.code) === 'SERVFAIL') {
                    resolve({ isValid: false, mxRecords: undefined, message: "not-found" });
                }
                else {
                    resolve({ isValid: false, mxRecords: undefined, message: (err === null || err === void 0 ? void 0 : err.message) || "error" });
                }
            });
        }
        catch (error) {
 ...
 */
async function checkEmails(emails, concurrency = 5) {
...
exports.isMXRecordValid = isMXRecordValid;
